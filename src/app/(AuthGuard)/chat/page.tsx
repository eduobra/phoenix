  ...
  return (
    ...
    {showScrollButton && (
      <button
        ...
        className="absolute p-3 text-white transition-all duration-300 bg-blue-900 rounded-full shadow-lg bottom-24 right-6 hover:bg-blue-800 animate-bounce z-50"
      >
