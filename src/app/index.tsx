  ...
  return (
    <section className="relative flex items-center justify-center min-h-screen overflow-hidden bg-gradient-hero">
      ...
      <div className="relative z-10 max-w-5xl px-6 mx-auto text-center">
        ...
        <h1 className="mb-6 text-6xl font-bold md:text-8xl text-hero-foreground">
        ...
        <p className="max-w-3xl mx-auto mb-8 text-xl leading-relaxed md:text-2xl text-hero-foreground/80">
        ...
        <div className="grid grid-cols-3 gap-8 pt-8 mt-16 border-t border-border/20">
          <div className="text-center">
            <div className="mb-2 text-3xl font-bold text-hero-foreground">50K+</div>
            <div className="text-sm text-hero-foreground/60">Active Users</div>
          </div>
          <div className="text-center">
            <div className="mb-2 text-3xl font-bold text-hero-foreground">99.9%</div>
            <div className="text-sm text-hero-foreground/60">Uptime</div>
          </div>
          <div className="text-center">
            <div className="mb-2 text-3xl font-bold text-hero-foreground">24/7</div>
            <div className="text-sm text-hero-foreground/60">AI Support</div>
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="relative px-6 py-24 overflow-hidden bg-gradient-hero">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <h2 className="mb-6 text-4xl font-bold md:text-6xl text-hero-foreground">
          Ready to Transform
          <span className="block text-transparent bg-gradient-primary bg-clip-text">Your Business?</span>
        </h2>

        <p className="max-w-2xl mx-auto mb-8 text-xl text-hero-foreground/80">
        ...
        <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
          {benefits.map((benefit, index) => (
            <div key={index} className="flex items-center gap-2 text-hero-foreground/80">
